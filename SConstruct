...
, 'async-redis-cli/redis-cli',  'async-redis-cli/unix1-include'
, 'async-redis-cli/unix1-include/event2']}
obj = Glob('*.cpp')
all_dirs = list_dir('./')
print all_dirs
for dir in all_dirs:
...
lib1 = File('async-redis-cli/unix1-include/lib/libevent.a')
lib2 = File('async-redis-cli/unix1-include/lib/libevent_core.a')
lib3 = File('async-redis-cli/unix1-include/lib/libevent_extra.a')
